  ...
  $(document).ready(function() {
    ...
    $('#search-toggle').click(function(e) {
      ...
      if ( searchToggle.hasClass('icon-cancel') ) {
        searchBox.slideUp();
        searchToggle.removeClass('icon-cancel').addClass('icon-search');
      } else {
        if ( $('#menu-toggle').hasClass('icon-cancel') ) {
          $('#menu-toggle').removeClass('icon-cancel').addClass('icon-list');
          $('.nav-menu').slideUp(400, function() {
            searchBox.slideDown();
            searchField.focus();
            searchToggle.addClass('icon-cancel').removeClass('icon-search');
          });
        } else {
          searchBox.slideDown();
          searchField.focus();
    ...
    $('#menu-toggle').click(function(){
      ...
      if ( menuToggle.hasClass('icon-cancel') ) {
        ...
        if ( $('#search-toggle').hasClass('icon-cancel') ) {
          $('#search-toggle').removeClass('icon-cancel').addClass('icon-search');
